...
#endif
#if defined(MOZJS_MAJOR_VERSION)
bool js_PluginGoogleAnalyticsJS_PluginGoogleAnalytics_enableExceptionReporting(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
    ...
    JS_ReportError(cx, "js_PluginGoogleAnalyticsJS_PluginGoogleAnalytics_enableExceptionReporting : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
